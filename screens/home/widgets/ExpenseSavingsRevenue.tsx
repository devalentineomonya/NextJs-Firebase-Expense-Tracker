...
const ExpenseSavingsRevenue = () => {
  ...
  return (
    <Card className="col-span-12 md:col-span-6 lg:col-span-4 flex flex-col shadow-[rgba(145,_158,_171,_0.3)_0px_0px_2px_0px,_rgba(145,_158,_171,_0.02)_0px_12px_24px_-4px] rounded-md bg-transparent">
...
export default ExpenseSavingsRevenue;
